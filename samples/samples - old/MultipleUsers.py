...
user_string1 = ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(12))
user_string2 = ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(12))

json_data = \
[
  {
    "user" : user_string1 + "@" + domain,
    "do" : [
      {
        "createEnterpriseID" : {
          "email" : user_string1 + "@" + domain,
          "country" : "US",
          "firstname" : "John",
          "lastname" : "Doe"
        }
  ...
  {
    "user" : user_string2 + "@" + domain,
    "do" : [
      {
        "createEnterpriseID" : {
          "email" : user_string2 + "@" + domain,
          "country" : "US",
          "firstname" : "Jane",
          "lastname" : "Doe"
        }
...
if res.status_code == 200:
    ...
    completed = res_json_data["completed"]
    if result == "success" and completed == 2:
      print("Success");
