...
| <a name="productConfigAdmin" class="api-ref-subtitle">Product Configuration Administrator</a> | A user role in an organization. A user with this role administers assiged Product Configuration descriptions, managing all associated administrative functions, such as adding and removing users from Product Configurations.  See full discussion at [Administrative Roles](https://helpx.adobe.com/enterprise/using/admin-roles.html#). |
...
| <a name="supportAdmin" class="api-ref-subtitle">Support Administrator</a> | A user role in an organization. A user with this non-administrative role has access to support-related information, such as customer-reported issue reports. See full discussion at [Administrative Roles](https://helpx.adobe.com/enterprise/using/admin-roles.html#). |
