...
| **removeFromOrg**, **removeFromDomain** | Remove the user from the organization, or from a Trusted Domain. 
The **removeFromOrg** operation removes the user from the organization and from any product configurations in the organization. 
