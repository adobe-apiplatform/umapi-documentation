...
<p>You should avoid any logic that expects fixed group names as these are liable to change without notice. We recommend using the [Groups API](/api/group.md) to fetch the latest group information.</p>
<hr class="api-ref-rule">
